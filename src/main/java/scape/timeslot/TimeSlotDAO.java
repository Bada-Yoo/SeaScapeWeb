...
public class TimeSlotDAO {
    ...
    public List<RoomDTO> findRoomsWithoutTimeSlotAndAssignedStore() {
        return new RoomDAO().findRoomsWithoutTimeSlotButAssignedToStore();
    }
